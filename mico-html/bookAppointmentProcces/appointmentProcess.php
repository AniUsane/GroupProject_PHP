...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    header("Location: appointmentDetails.php?patientName=$patientName&doctorName=$doctorName&departmentName=$departmentName&phoneNumber=$phoneNumber&symptoms=$symptoms&date=$date");
    exit();
}
?>